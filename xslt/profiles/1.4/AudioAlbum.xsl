...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Release Profile for Audio Album Music And Speech (version 1.4) for the&#xA;      NewReleaseMessage."
                              schemaVersion="">
         <xsl:comment>
      ...
      4.15(11).</svrl:text>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">AudioAlbumMusicAndSpeech_ReleaseProfileVersionId</xsl:attribute>
            <xsl:attribute name="name">AudioAlbumMusicAndSpeech_ReleaseProfileVersionId</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">AudioAlbumMusicAndSpeech_MustContainSoundRecording</xsl:attribute>
            <xsl:attribute name="name">AudioAlbumMusicAndSpeech_MustContainSoundRecording</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MultiProfile_MustContainNonMusicalWorkSoundRecording</xsl:attribute>
            <xsl:attribute name="name">MultiProfile_MustContainNonMusicalWorkSoundRecording</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">AudioAlbum_MustContainAlbumOrSingleRelease</xsl:attribute>
            <xsl:attribute name="name">AudioAlbum_MustContainAlbumOrSingleRelease</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MultiProfile_MustContainNonMusicalWorkSoundRecording2</xsl:attribute>
            <xsl:attribute name="name">MultiProfile_MustContainNonMusicalWorkSoundRecording2</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Audio Album Music And Speech (version 1.4) for the
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M6">
      ...
      <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            #Audio Album Music And Speech) No deprecated date elements should be used.</svrl:text>
      ...
      <xsl:if test="MIDI/MasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="MIDI/MasteredDate">
            ...
            <svrl:text>Information: #Audio Album Music And
            Speech) No deprecated date elements should be used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="ReleaseDetailsByTerritory/OriginalDigitalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: #Audio Album Music And Speech) No deprecated date elements should be
            used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="Release/GlobalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            Music And Speech) No deprecated date elements should be used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="Release/GlobalOriginalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            Album Music And Speech) No deprecated date elements should be used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: #Audio Album Music And Speech) The
            MessageSchemaVersionId should be at least 3.9.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="ResourceGroup">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
            ...
            <svrl:text>Information: #Audio Album Music And
            Speech) There should not be more than 5 nested ResourceGroups.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M8"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) One component release
            ...
            Clause 3.1, Rule 1697-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M11">
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            = True (Release Profile 1.4, Clause 3.3.1(1), Rule 1698-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            specified (Release Profile 1.4, Clause 3.3.1(1), Rule 1698-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M11"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Audio Album Music And
            Speech) Track bundle resource groups should be sequenced (Release Profile 1.4, Clause
            3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1699-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[@IsMainRelease = 'true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber &gt; '1'] and not(descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber = '1'])">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) All Primary Resources
   ...
   <xsl:template match="//ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"
      ...
      <xsl:if test="SequenceNumber">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
            ...
            <svrl:text>Error: #Audio Album Music And Speech)
            Secondary Resources (e.g. cover images) content items shall not be sequenced (Release
            Profile 1.4, Clause 3.3.1(4), Rule 1703-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M16"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Fatal Error: #Audio Album Music And Speech)
            Primary SoundRecording Resources shall have an IndirectSoundRecordingId (Release Profile
            1.4, Clause 3.3.1(6), Rule 1704-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M17"/>
   ...
   <xsl:template match="*:ResourceGroupContentItem/ReleaseResourceReference"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 4.3(1)+4.3(2), Rule 1705-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M18"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) A Single ReferenceTitle
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) At least one Title of
            type FormalTitle shall be provided for the default Worldwide ReleaseDetailsByTerritory
            section (Release Profile 1.4, Clause 4.3(4), Rule 1708-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M21"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            section (Release Profile 1.4, Clause 4.3(4), Rule 1709-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M22"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Audio Album Music And Speech) If more than one LabelName is provided, exactly
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position() = 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Audio Album Music And Speech) If a LabelName is not specified for
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Audio Album Music And
            Speech) The LabelNameType shall be 'UserDefined' if a user-defined value is supplied for
            a LabelName (Release Profile 1.4, Clause 4.3(6b), Rule 1714-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@Namespace">
               ...
               <svrl:text>Error: #Audio Album Music And Speech) The
            appropriate Namespace for the user-defined value shall be provided (Release Profile
            1.4, Clause 4.3(6b), Rule 1714-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M29"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position = 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) If a Genre is not
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Audio Album Music And Speech) The appropriate ParentalWarningType
            shall be provided (Release Profile 1.4, Clause 4.3(8), Rule 1716-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M31"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Audio Album Music And Speech) A
            GlobalReleaseDate or a ReleaseDate shall be provided for each Release (Release Profile
            1.4, Clause 4.3(9), Rule 1717-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M32"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Audio Album Music And Speech) If there is a
            MusicalWork, there has to be a creative contributor (Release Profile 1.4, Clause
            4.3(12a), Rule 1719-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M34"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList/SoundRecording/SoundRecordingDetailsByTerritory"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 4.3(12a), Rule 1720-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M35"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) ResourceContributors
            shall be provided only once (with multiple roles) (Release Profile 1.4, Clause
            4.3(13)+4.3(20), Rule 1721-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M36"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M37">
      ...
      <xsl:if test="*/*/DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
            ...
            the Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1722-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M37"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList/*/*"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 4.3(21), Rule 1723-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M38"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) A RightSharePercentage
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M42">
      ...
      <xsl:if test="SoundRecording/IsHiddenResource | MIDI/IsHiddenResource | Video/IsHiddenResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) IsHiddenResource must not
      ...
      <xsl:if test="SoundRecording/IsBonusResource | MIDI/IsBonusResource | Video/IsBonusResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) IsBonusResource must not
            be used on a Resource (Release Profile 1.4, Clause 4.3(24)+4.10(7g)+4.10(7h), Rule
            1727-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="(substring(@IdentifierType, 1, 3) = 'ISO' or not(@IdentifierType)) and string-length(normalize-space(text())) != 2 and text() != 'Worldwide' and translate(text(), 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', '') != ''">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) A TerritoryCode of type
            'ISO' must be a two-letter code or 'Worldwide' (Release Profile 1.4, Clause 4.3(25),
            Rule 1728-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) A deprecated
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS'">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            Profile 1.4, Clause 4.3(25), Rule 1729-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M44"/>
   </xsl:template>
   ...
   <xsl:template match="//PartyId[@IsISNI = 'true']" priority="1000" mode="M45">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            pattern [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1730-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M45"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) An ISRC must be a string
            starting with an ISO 3166 code or FX, QM, UK, CP, DG or ZZ (Release Profile 1.4,
            Clause 4.3(30), Rule 1731-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M46"/>
   ...
   <xsl:template match="//GRid" priority="1000" mode="M47">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [a-zA-Z0-9]{18} (Release Profile 1.4, Clause 4.3(30), Rule 1732-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M47"/>
   ...
   <xsl:template match="//ISSN" priority="1000" mode="M49">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1734-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M49"/>
   ...
   <xsl:template match="//ISBN" priority="1000" mode="M50">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1735-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M50"/>
   ...
   <xsl:template match="//VISAN" priority="1000" mode="M51">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 4.3(30), Rule 1736-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M51"/>
   ...
   <xsl:template match="//ISAN" priority="1000" mode="M52">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 4.3(30), Rule 1737-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M52"/>
   ...
   <xsl:template match="//ISMN" priority="1000" mode="M53">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            979[0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1738-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M53"/>
   ...
   <xsl:template match="//ISWC" priority="1000" mode="M54">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [a-zA-Z][0-9]{10} (Release Profile 1.4, Clause 4.3(30), Rule 1739-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M54"/>
   ...
   <xsl:template match="//*[(name() != 'LabelName') and @UserDefinedValue]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 4.3(31), Rule 1741-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@Namespace">
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech)
            The appropriate Namespace for the user-defined value shall be provided (Release Profile
            1.4, Clause 4.3(31), Rule 1741-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M56"/>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M57">
      ...
      <xsl:if test="//Comment">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
            ...
            <svrl:text>Error: #Audio Album Music And Speech) No Comment
            shall be provided (Release Profile 1.4, Clause 4.3(32), Rule 1742-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M57"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@SequenceNumber]" priority="1000" mode="M60">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) SequenceNumbers must run
      ...
      <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Audio Album Music And Speech) SequenceNumbers must all
            be different (Release Profile 1.4, Clause 4.3(35), Rule 1745-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M60"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@HasMaxValueOfOne = 'true']" priority="1000" mode="M61">
      ...
      <xsl:if test="number(.) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
            ...
            (Release Profile 1.4, Clause 4.3(36a), Rule 1746-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M61"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@HasMaxValueOfOne = 'false']" priority="1000" mode="M62">
      ...
      <xsl:if test="number(.) &lt;= 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
            ...
            Clause 4.3(36b), Rule 1747-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M62"/>
   </xsl:template>
   ...
   <xsl:template match="//RightSharePercentage[not(@HasMaxValueOfOne)]"
      ...
      <xsl:if test="number(.) &lt;= 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
            ...
            Speech) Percentages are typically provided in the interval between 0 and 100. The value
            provided seems to indicate a value equal to, or less than, 1% (Release Profile 1.4,
            Clause 4.3(36b), Rule 1748-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M63"/>
   </xsl:template>
   ...
   <!--PATTERN AudioAlbumMusicAndSpeech_ReleaseProfileVersionId-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) The
            ReleaseProfileVersionId should be 'CommonReleaseTypes/14/AudioAlbum'
            (Release Profile 1.4, Clause 3.2, Rule 1749-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M64"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M65">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            TrackRelease (Release Profile 1.4, Clause 3.1, Rule 1750-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M65"/>
   ...
   <!--PATTERN AudioAlbumMusicAndSpeech_MustContainSoundRecording-->
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M66">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 3.1, Rule 1751-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M66"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M67">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            1.4, Clause 3.1, Rule 1752-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M67"/>
   ...
   <!--PATTERN MultiProfile_MustContainNonMusicalWorkSoundRecording-->
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M68">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="SoundRecording/SoundRecordingType[text() = 'NonMusicalWorkSoundRecording']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="SoundRecording/SoundRecordingType[text() = 'NonMusicalWorkSoundRecording']">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: #Audio Album Music And Speech) A Release of this type
            must contain one SoundRecording of type NonMusicalWorkSoundRecording (Release Profile
            1.4, Clause 3.1, Rule 1753-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M68"/>
   ...
   <!--PATTERN MultiProfile_MustContainOneFrontCoverImageAsSecondaryResource-->
	  ...
	  <!--RULE -->
   <xsl:template match="//Release[@IsMainRelease='true']/ResourceGroup/ResourceGroupContentItem"
                 priority="1000"
                 mode="M69">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//Release[@IsMainRelease='true']/ResourceGroup/ResourceGroupContentItem"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 3.1, Rule 1754-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M69"/>
   ...
   <!--PATTERN AudioAlbum_MustContainAlbumOrSingleRelease-->
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M70">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="Release/ReleaseType[text() = 'Single'] | Release/ReleaseType[text() = 'Album']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) An Audio Album must
            contain one Album release or one Single release (for multi-track singles) (Release
            Profile 1.4, Clause 3.1, Rule 1755-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M70"/>
   ...
   <!--PATTERN MultiProfile_MustContainNonMusicalWorkSoundRecording2-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) A Release of this type
            must contain one SoundRecording of type NonMusicalWorkSoundRecording (Release Profile
            1.4, Clause 3.1, Rule 1756-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M71"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[ReleaseType[text() = 'TrackRelease']]/ReleaseResourceReferenceList"
      ...
      <xsl:if test="count(ReleaseResourceReference) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            (Release Profile 1.4, Clause 3.1, Rule 1757-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M72"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M73">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            primary) (Release Profile 1.4, Clause 3.1, Rule 1758-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M73"/>
   ...
   <!--PATTERN AudioAlbum_MustContainMultipleSoundRecordings-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M74">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage/ResourceList"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 3.1, Rule 1759-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M74"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M75">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            1.4, Clause 3.1, Rule 1760-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M75"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 4.3(12c)+4.3(15b), Rule 1761-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M76"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Audio Album Music And Speech) DisplayArtistNames for Release and
   ...
   <!--PATTERN MultiProfile_MainReleaseMustHaveGridOrICPN-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M78">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage/ReleaseList"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) The MainRelease shall be
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) Primary SoundRecording
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio Album Music And Speech) Secondary Resources shall
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 4.4(8), Rule 1766-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M81"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Audio
            Album Music And Speech) A LabelName has to be specified for each Release (Release
            Profile 1.4, Clause 4.10(8), Rule 1767-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M82"/>
