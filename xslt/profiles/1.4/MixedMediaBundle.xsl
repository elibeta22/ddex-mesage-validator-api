...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Release Profile for Mixed Media Bundle (version 1.4) for the&#xA;      NewReleaseMessage."
                              schemaVersion="">
         <xsl:comment>
      ...
      4.15(11).</svrl:text>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MixedMediaBundle_ReleaseProfileVersionId</xsl:attribute>
            <xsl:attribute name="name">MixedMediaBundle_ReleaseProfileVersionId</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MixedMediaBundle_MustContainTwoDifferentResourceTypes</xsl:attribute>
            <xsl:attribute name="name">MixedMediaBundle_MustContainTwoDifferentResourceTypes</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MixedMediaBundle_MustContainBundle</xsl:attribute>
            <xsl:attribute name="name">MixedMediaBundle_MustContainBundle</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MixedMediaBundle_MainReleaseMustBeMultimedia</xsl:attribute>
            <xsl:attribute name="name">MixedMediaBundle_MainReleaseMustBeMultimedia</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Mixed Media Bundle (version 1.4) for the
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M6">
      ...
      <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            #Mixed Media Bundle) No deprecated date elements should be used.</svrl:text>
      ...
      <xsl:if test="MIDI/MasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="MIDI/MasteredDate">
            ...
            <svrl:text>Information: #Mixed Media Bundle) No
      ...
      <xsl:if test="ReleaseDetailsByTerritory/OriginalDigitalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: #Mixed Media Bundle) No deprecated date elements should be
            used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="Release/GlobalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: #Mixed Media
      ...
      <xsl:if test="Release/GlobalOriginalReleaseDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: #Mixed
            Media Bundle) No deprecated date elements should be used.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="MIDI/RemasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="MIDI/RemasteredDate">
            ...
            <svrl:text>Information: #Mixed Media Bundle)
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: #Mixed Media Bundle) The MessageSchemaVersionId should
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="ResourceGroup">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
            ...
            <svrl:text>Information: #Mixed Media Bundle) There
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) One component release should be
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M11">
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            (Release Profile 1.4, Clause 3.3.1(1), Rule 1481-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            (Release Profile 1.4, Clause 3.3.1(1), Rule 1481-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M11"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) Track
            bundle resource groups should be sequenced (Release Profile 1.4, Clause
            3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1482-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) All
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[@IsMainRelease = 'true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber &gt; '1'] and not(descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber = '1'])">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) All Primary Resources should be
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Fatal Error: #Mixed Media Bundle) Primary
            SoundRecording Resources shall have an IndirectSoundRecordingId (Release Profile 1.4,
            Clause 3.3.1(6), Rule 1487-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M17"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle)
            For each ReleaseResourceReference a ReleaseResourceType shall be provided (Release
            Profile 1.4, Clause 4.3(1)+4.3(2), Rule 1488-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M18"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) A Single ReferenceTitle must be
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) At least one Title of type
            FormalTitle shall be provided for the default Worldwide ReleaseDetailsByTerritory
            section (Release Profile 1.4, Clause 4.3(4), Rule 1491-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M21"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            section (Release Profile 1.4, Clause 4.3(4), Rule 1492-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M22"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Mixed Media Bundle) If more than one LabelName is provided, exactly one shall
            be a DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1495-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M27"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position() = 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Mixed Media Bundle) If a LabelName is not specified for the
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Mixed Media Bundle) The
            LabelNameType shall be 'UserDefined' if a user-defined value is supplied for a LabelName
            (Release Profile 1.4, Clause 4.3(6b), Rule 1497-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position = 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) If a Genre is not specified for the
            Worldwide ReleaseDetailsByTerritory, it needs to be specified in all the other
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Mixed Media Bundle) The appropriate ParentalWarningType shall be
            provided (Release Profile 1.4, Clause 4.3(8), Rule 1499-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M31"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Mixed Media Bundle) A GlobalReleaseDate or
            a ReleaseDate shall be provided for each Release (Release Profile 1.4, Clause 4.3(9),
            Rule 1500-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M32"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Mixed Media Bundle) A ResourceReleaseDate
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Mixed Media Bundle) If there is a
            MusicalWork, there has to be a creative contributor (Release Profile 1.4, Clause
            4.3(12a), Rule 1502-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M34"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) ResourceContributors shall be
            provided only once (with multiple roles) (Release Profile 1.4, Clause 4.3(13)+4.3(20),
            Rule 1504-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M36"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M37">
      ...
      <xsl:if test="*/*/DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
            ...
            Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1505-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M37"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Fatal Error: #Mixed Media Bundle)
            IndirectResourceContributors shall be provided only once (with multiple roles) (Release
            Profile 1.4, Clause 4.3(21), Rule 1506-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M38"/>
   ...
   <xsl:template match="//MusicalWork" priority="1000" mode="M39">
      ...
      <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            must not exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1507-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M39"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) A RightSharePercentage has a value
            between 0 and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1508-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M40"/>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M42">
      ...
      <xsl:if test="SoundRecording/IsHiddenResource | MIDI/IsHiddenResource | Video/IsHiddenResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) IsHiddenResource must not be used
      ...
      <xsl:if test="SoundRecording/IsBonusResource | MIDI/IsBonusResource | Video/IsBonusResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) IsBonusResource must not be used on
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="(substring(@IdentifierType, 1, 3) = 'ISO' or not(@IdentifierType)) and string-length(normalize-space(text())) != 2 and text() != 'Worldwide' and translate(text(), 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', '') != ''">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) A TerritoryCode of type 'ISO' must
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) A TerritoryCode of type 'TIS' must
            be a numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1511-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) A deprecated TerritoryCode must be
            a four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1511-3).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M43"/>
   </xsl:template>
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS'">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            1.4, Clause 4.3(25), Rule 1512-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M44"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed
            Media Bundle) A PartyId of type 'ISNI' must be a string conforming to the pattern
            [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1513-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M45"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) An ISRC must be a string starting
            with an ISO 3166 code or FX, QM, UK, CP, DG or ZZ (Release Profile 1.4, Clause 4.3(30),
            Rule 1514-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M46"/>
   ...
   <xsl:template match="//GRid" priority="1000" mode="M47">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Profile 1.4, Clause 4.3(30), Rule 1515-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M47"/>
   ...
   <xsl:template match="//SICI" priority="1000" mode="M48">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [0-9]{4}-[0-9]{3}[X0-9].+ (Release Profile 1.4, Clause 4.3(30), Rule 1516-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M48"/>
   ...
   <xsl:template match="//ISSN" priority="1000" mode="M49">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1517-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M49"/>
   ...
   <xsl:template match="//ISBN" priority="1000" mode="M50">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1518-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M50"/>
   ...
   <xsl:template match="//ISAN" priority="1000" mode="M52">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            1.4, Clause 4.3(30), Rule 1520-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M52"/>
   ...
   <xsl:template match="//ISMN" priority="1000" mode="M53">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 4.3(30), Rule 1521-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M53"/>
   ...
   <xsl:template match="//ISWC" priority="1000" mode="M54">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 4.3(30), Rule 1522-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M54"/>
   ...
   <xsl:template match="//ICPN" priority="1000" mode="M55">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 1523-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M55"/>
   ...
   <xsl:template match="//*[(name() != 'LabelName') and @UserDefinedValue]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 4.3(31), Rule 1524-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M56"/>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M57">
      ...
      <xsl:if test="//Comment">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
            ...
            <svrl:text>Error: #Mixed Media Bundle) No Comment shall be
            provided (Release Profile 1.4, Clause 4.3(32), Rule 1525-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M57"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@SequenceNumber]" priority="1000" mode="M60">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) SequenceNumbers must run from 1 to
      ...
      <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Mixed Media Bundle) SequenceNumbers must all be
            different (Release Profile 1.4, Clause 4.3(35), Rule 1528-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M60"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@HasMaxValueOfOne = 'true']" priority="1000" mode="M61">
      ...
      <xsl:if test="number(.) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
            ...
            Profile 1.4, Clause 4.3(36a), Rule 1529-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M61"/>
   </xsl:template>
   ...
   <!--PATTERN MixedMediaBundle_ReleaseProfileVersionId-->
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M64">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*:NewReleaseMessage"/>
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14/MixedMediaBundle'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14/MixedMediaBundle'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: #Mixed Media Bundle) The ReleaseProfileVersionId should
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[ReleaseType[text() = 'TrackRelease']]/ReleaseResourceReferenceList"
      ...
      <xsl:if test="count(ReleaseResourceReference) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            Profile 1.4, Clause 3.1, Rule 1533-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M65"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Mixed Media Bundle) Primary Video Resources should be identified
            with an ISRC (Release Profile 1.4, Clause 3.1, Rule 1534-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M66"/>
   ...
   <!--PATTERN MixedMediaBundle_MustContainTwoDifferentResourceTypes-->


	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M67">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*:NewReleaseMessage"/>

		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="count(distinct-values(//ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType='PrimaryResource']]/ResourceType)) &gt; 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) A Mixed Media Bundle must contain
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) A Release of this type must contain
            exactly one Image of type FrontCoverImage as a secondary Resource (Release Profile 1.4,
            Clause 3.1, Rule 1536-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M68"/>
   ...
   <!--PATTERN MixedMediaBundle_MustContainBundle-->


	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M69">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage/ReleaseList"/>

		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="Release/ReleaseType[text() = 'Bundle'] | Release/ReleaseType[text() = 'MultimediaSingle']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M70">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            (Release Profile 1.4, Clause 3.1, Rule 1538-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M70"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M71">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            TrackRelease (Release Profile 1.4, Clause 3.1, Rule 1539-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M71"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M72">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 3.1, Rule 1540-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M72"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 4.3(12c)+4.3(15b), Rule 1541-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M73"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Mixed Media Bundle) DisplayArtistNames for Release and Resource
            must be different (Release Profile 1.4, Clause 4.3(16a), Rule 1542-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M74"/>
   </xsl:template>
   ...
   <!--PATTERN MixedMediaBundle_MainReleaseMustBeMultimedia-->
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[@IsMainRelease = 'true']"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="ReleaseType[text() = 'MultimediaSingle'] | ReleaseType[text() = 'Bundle']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="ReleaseType[text() = 'MultimediaSingle'] | ReleaseType[text() = 'Bundle']">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: #Mixed Media Bundle) The MainRelease must have a
   ...
   <!--PATTERN MultiProfile_MainReleaseMustHaveGridOrICPN-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M76">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage/ReleaseList"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) The MainRelease shall be identified
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) Primary SoundRecording Resources
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Mixed Media Bundle) Secondary Resources shall be
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Clause 4.6(9), Rule 1547-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M79"/>
