...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: The MessageSchemaVersionId should be at least 3.9
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/InteractiveAdSupportedStreamingService')]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14//14//14/AudioSingle'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14//14//14/AudioSingle'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN NonInteractiveSubscriptionStreamingService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonInteractiveSubscriptionStreamingService')]"
                 priority="1000"
                 mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/RingtonesAndMobileService')]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14//14//14/Ringtone'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14//14//14/Ringtone'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN AdSupportedDownloadService_Categories-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']]"
                 priority="1000"
                 mode="M107">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
